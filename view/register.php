              ...
              <div class="col-lg">
                <div class="p-5">
                  ...
                  <form method="POST" action="">
                    ...
                    <div class="form-group">
                      <input required="required" type="text" name="nama" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nama Sesuai KTP">
                    </div>
                    <div class="form-group">
...
?>
                    <div class="form-group">
                      <div class="small">
                        <center><b align="center" class="text-danger">NIK Tidak Valid !</b></center>
                      </div>
                    </div>
<?php
  }
...
<?php
if(isset($_GET['berhasil'])){
  if($_GET['berhasil']=="error_username"){
?>
                    <div class="form-group">
                      <div class="small">
                        <center><b align="center" class="text-danger">Username Tidak boleh Mengandung Simbol dan Spasi !</b></center>
                      </div>
                    </div>
<?php
  }
